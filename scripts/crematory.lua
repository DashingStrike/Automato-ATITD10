...
function addWindow(vPos)
  ...
  local vFire = srFindImageInRange("crematory/crem-fire.png", newWindow.origin[1] - 31,
...
function resetWindow(current)
  local vLime = srFindImageInRange("crematory/crem-lime.png", current.origin[1] - 20,
  ...
  local vFire = srFindImageInRange("crematory/crem-fire.png", current.origin[1] - 31,
...
function start()
  ...
  if windows then
    ...
    windows = {};
    local posList = findAllImages("crematory/crem-lime.png");
    if #posList == 0 then
...
function findPoints(current)
  ...
  for i=1,7 do
    ...
    local point = srFindImageInRange("crematory/crem-point.png", offset[1],
                                     offset[2] - 5,
