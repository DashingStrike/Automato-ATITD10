...
--    stats = srFindImage("endurance2.png"); -- If using endurance, we can click early (before all white) on semi-dark red
--  end
--  if not stats then
--    --stats = srFindImage("AllStats-Black3.png");
--    stats = srFindImage("endurance3.png"); -- If using endurance, we can click early (before all white) on dark red
--  end
--  return stats;
--end
