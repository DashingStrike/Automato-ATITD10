...
resins = {
	...
	"Ash Palm",
	"Autumn Bloodbark",
	"Autumn Bloodbark Sapling",
	"Autumn Bloodbark Youth",
	"Beetlenut",
	"Blaze Maple",
	"Blaze Maple Sapling",
	"Blaze Maple Youth",
	...
	"Jacaranda Youth",
	"Japanese cherry",
	"Japanese Cherry Sapling",
	"Japanese Cherry Youth",
	"Kaeshra",
	"Katsura Sapling",
	"Katsura Tree",
	"Katsura Youth",
	...
	"Parrotia Youth",
	"Passam",
	"Peaches 'n Cream Maple",
	"Peaches 'n Cream Sapling",
	"Peaches 'n Cream Youth",
	"Phoenix Palm",
	"Pratyeka Tree",
	"Ranyahn",
	"Razor Palm",
...
function parseChat()
	for try=1,10 do
		...
		quality, scent, feeling, pos, neg = string.match(lastLineParse, "You catch a whif of quality (%d+) (%D+) scented incense. You are filled with a (%D+) (%D+), yet a bit of (%D+).");
